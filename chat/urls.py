...
from .views import ( ChatCreateView, ConversacionView, MensajesRecibidosView, 
                    MensajesEnviadosView, BorrarConversacionView )
...
urlpatterns = [
    ...
    path("chat/borrar-conversacion/<int:remitente_id>/<int:destinatario_id>/", BorrarConversacionView.as_view(), name="borrar_conversacion"),
]